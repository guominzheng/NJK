		...
		<div id="sidebar">
				...
				<div id="sidebar-shortcuts">
					...
					<div id="sidebar-shortcuts-large">
						...
						<button class="btn btn-small btn-success" onclick="a();" title="切换菜单"><i class="icon-pencil"></i></button>
					  ...
					  <ul class="submenu">
							<c:forEach items="${menu.subMenu}" var="sub">
								...
								<c:choose>
									...
									<c:otherwise>
									<li><a href="javascript:void(0);"><i class="icon-double-angle-left icon-double-angle-right"></i>${sub.MENU_NAME }</a></li>
									</c:otherwise>
								</c:choose>
								</c:if>
							</c:forEach>
