...
<body>
<form action="coupon/oneKey" name="Form" id="Form" method="post">
    <div id="zhongxin">
        <table id="table_report" class="table table-striped table-bordered table-hover">
            ...
            <tr>
                <td style="width:70px;text-align: right;padding-top: 13px;">优惠金额:</td>
                <td><input type="text" name="JIAN" id="JIAN" value="${pd.JIAN}" maxlength="32" title="发送金额"
                           /></td>
            </tr>
            <tr>
                <td style="width:70px;text-align: right;padding-top: 13px;">活动结束时间:</td>
                <td><input type="text" name="END" id="END" value="${pd.END}" maxlength="32" placeholder="这里输入消费额度"
                           title="活动结束时间" class="span10 date-picker"/></td>
            </tr>
            ...
            <tr>
                ...
                <td><input type="text" name="BEIZHU" id="BEIZHU" value="${pd.BEIZHU}" maxlength="32" placeholder="这里上传图片信息" title="商品排序"/></td>
            </tr>
            <tr>
