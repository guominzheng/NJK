...
<body>
	<form action="pply_vip/${msg }.do" name="Form" id="Form" method="post">
		<input type="hidden" name="APPLYVIP_ID" id="APPLYVIP_ID" value="${pd.APPLYVIP_ID}"/>
		...
		<table id="table_report" class="table table-striped table-bordered table-hover">
			...
			<tr>
				<td style="width:70px;text-align: right;padding-top: 13px;">商品权限:</td>
				<%-- <td><input type="text" name="STATUS" id="STATUS" value="${pd.STATUS}" maxlength="32" placeholder="这里输入状态" title="状态"/></td> --%>
				<td>
