...
<body>
    <form action="live_post/${msg }.do" name="Form" id="Form" method="post">
        ...
        <table id="table_report" class="table table-striped table-bordered table-hover">
            ...
            <tr>
                <td style="width:70px;text-align: right;padding-top: 13px;">H5路径:</td>
                <td><input style="width:300PX" type="text" name="URL" id="URL" value="${pd.URL}" maxlength="300" placeholder="这里输入H5路径没有不传" title="H5路径"/></td>
            </tr>
            <tr>
