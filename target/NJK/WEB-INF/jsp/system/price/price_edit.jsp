...
<body>
    <form action="price/${msg }.do" name="Form" id="Form" method="post">
        ...
        <table id="table_report" class="table table-striped table-bordered table-hover">
            <tr>
                <td style="width:70px;text-align: right;padding-top: 13px;">数量1:</td>
                <td><input type="text" name="MIN" id="MIN" value="${pd.MIN}" maxlength="32" placeholder="这里输入数量1" title="数量1"/></td>
        </tr>
        <tr>
                <td style="width:70px;text-align: right;padding-top: 13px;">数量2:</td>
                <td><input type="text" name="MAX" id="MAX" value="${pd.MAX}" maxlength="32" placeholder="这里输入数量2" title="数量2"/></td>
        </tr>
        <tr>
                <td style="width:70px;text-align: right;padding-top: 13px;">最小价格:</td>
