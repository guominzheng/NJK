...
<body>
	<form action="banner/${msg }.do" name="Form" id="Form" method="post">
		...
		<table id="table_report" class="table table-striped table-bordered table-hover">
			...
			<tr>
				<td style="width:120px;text-align: right;padding-top: 13px;">图片描述</td>
				<td><textarea name="DATE" id="DATE" style="width:200px;height:80px;" placeholder="图片描述" title="图片描述">${pd.DATE}</textarea>
			</tr>
			<tr>
