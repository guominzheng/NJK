										...
										<c:if test="${QX.cha == 1 }">
											<c:forEach items="${varList}" var="var" varStatus="vs">
												<tr>
													...
													<td class="center"><a href="${var.PICTURE}" title=""
														target="_blank"><img src="${var.PICTURE}" alt=""
															width="100"></a></td>
													<td class="center"><c:if
															test="${var.NAME != '1' }">
															<span class="label label-important arrowed-in">商品轮播图</span>
														</c:if> <c:if test="${var.NAME == '1' }">
															<span class="label label-success arrowed">社区大图</span>
														</c:if></td>
