        ...
        <div id="page-content" class="clearfix">
            ...
            <div class="row-fluid">
                ...
                <div class="row-fluid">
                    ...
                    <!-- 检索  -->
                    <form action="content/list.do" method="post" name="Form" id="Form">
                        <!-- 检索  -->
                                    ...
                                    <c:when test="${not empty varList}">
                                            <c:forEach items="${varList}" var="var" varStatus="vs">
                                               ...
                                               <td class='center' style="width: 30px;">
                                                    <label><input type='checkbox' name='ids' value="${var.CENSUS_ID}" /><span class="lbl"></span></label>
                                                </td>
                                                ...
                                                <td class='center'>${var.STOP_DATE}</td>
                                                </tr>
