...
<body>
	<form action="product_type/${msg }.do" name="Form" id="Form" method="post">
		<input type="hidden" name="PRODUCT_TYPE_ID" id="PRODUCT_TYPE_ID" value="${pd.PRODUCT_TYPE_ID}"/>
		<div id="zhongxin">
		<table id="table_report" class="table table-striped table-bordered table-hover">
			<tr>
				<td style="width:70px;text-align: right;padding-top: 13px;">商品类型名称:</td>
				<td><input type="text" name="TYPE_NAME" id="TYPE_NAME" value="${pd.TYPE_NAME}" maxlength="32" placeholder="这里输入类型名称" title="类型名称"/></td>
			</tr>
			<tr>
