...
import com.fh.util.weixinm.GetPinyin;
...
public class UserController extends BaseController {
	...
	public List<PageData> selectCity() throws Exception{
		...
		pd = this.getPageData();
		List<PageData> dizhi=sys_cityService.listAll(pd);
		return dizhi;
	}
	 ...
	 * @throws Exception 
	 */
	@RequestMapping(value="/selectCity1")
	@ResponseBody
	public List<PageData> selectCity1() throws Exception{
		logBefore(logger, "根据类型显示代理商下拉选 ");
		PageData pd = new PageData();
		pd = this.getPageData();
		List<PageData> dizhi1=sys_cityService.listAll(pd);
		return dizhi1;
	}
