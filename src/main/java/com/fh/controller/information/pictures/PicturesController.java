...
public class PicturesController extends BaseController {
	 ...
	 * 上传
	 */
	@RequestMapping(value = "/unloadPicture")
	@ResponseBody
	public Object saveP(@RequestParam(required = false) MultipartFile file) throws Exception {
...
//		}
//		map.put("id", ffile+"/"+fileName);
		map.put("path",  Const.SERVERPATH+Const.FILEPATHIMG);
		map.put("id1", ffile);
		map.put("id2", fileName);
