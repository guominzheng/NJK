...
public class PhoneAddress {
    ...
    public static String getMobileAttribution(String Mobile){
        String str = getMobileNoTrack(Mobile);
        String strArry1 [] = str.split(" ");
        System.out.println(strArry1.length);
        if(strArry1.length==3){
    ...
    public static void main(String[] args) {
        ...
        System.out.println(getMobileAttribution("18"));
    }
}
