...
import com.fh.util.netty.init.AfterSpringBegin;
...
public class WebSocketServer extends AfterSpringBegin {
    ...
    public static void main(String[] args) {
        try {
            ...
            ws.bossGroup= new NioEventLoopGroup();
            ws.childChannelHandler=new WebSocketChildChannelHandler();
            ws.workerGroup=new NioEventLoopGroup();
            ws.serverBootstrap=new ServerBootstrap();
            ws.port=7397;
            ws.run();
        } catch (Exception e) {
            e.printStackTrace();
