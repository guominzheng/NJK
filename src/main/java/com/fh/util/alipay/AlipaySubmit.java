    ...
    *//**
	...
	public static String buildRequestMysign(Map<String, String> sPara) {
        ...
        if(AlipayConfig.sign_type.equals("MD5") ) {
        	String key = "";
        	System.out.println("partner:"+sPara.get("partner"));
        	System.out.println("MemberContent.Kgy_Ali_MerId:"+MemberContent.Kgy_Ali_MerId);
        	System.out.println("passPartner:"+(MemberContent.Kgy_Ali_MerId.equals(sPara.get("partner"))));
        	System.out.println("beforeKey:"+key);
        	if(MemberContent.Kgy_Ali_MerId.equals(sPara.get("partner"))) {
        		key = MemberContent.Kgy_Ali_Key;
        	} else {
        		key = AlipayConfig.key;
        	}
        	System.out.println("afterKey:"+key+";"+sPara.get("partner"));
