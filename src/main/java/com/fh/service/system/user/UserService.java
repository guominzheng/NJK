...
public class UserService {
	...
	public void editP(PageData pd) throws Exception {
		dao.update("UserXMapper.editP", pd);
	}
	 ...
	 * 社区商家
	 */
	public List<PageData> wisdomlistPage(Page page) throws Exception {
		return (List<PageData>) dao.findForList("UserXMapper.wisdomlistPage", page);
	}
	 ...
	 * 通过ROLE_ID查询代理商
	 */
	public List<PageData> findAgent(PageData pd) throws Exception{
		return (List<PageData>) dao.findForList("UserXMapper.findAgent", pd);
	}
}
