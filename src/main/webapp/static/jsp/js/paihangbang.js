...
console.log(strs12[0])
$(function(){
		$.ajax({  
        url : "http://m.nongjike.cn/NJK/app/findWeiXinCiShuPaiHang",
        type: "POST",
        ...
        success: function(data){
				...
				Ranking.innerHTML=data.paiming.count1+"<span>次</span>"
				...
				for(var i=0;i<data.data.length;i++){
					...
					if(parseInt(i%2)!=0){
						...
						cishus.innerHTML=data.data[i].count1+"次"
