...
<body>
        ...
        <div id="page-content" class="clearfix">
            ...
            <div class="row-fluid">
                ...
                <div class="row-fluid">
                    ...
                    <!-- 检索  -->
                    <form action="live_post/list.do" method="post" name="Form" id="Form">
                        <table>
                            <tr>
    ...
    <script type="text/javascript">
        ...
        function add(){
             ...
             diag.Drag=true;
             diag.Title ="新增";
             diag.URL = '<%=basePath%>live_post/goAdd.do';
             diag.Width = 1000;
             diag.Height = 1000;
        ...
        function del(Id){
            bootbox.confirm("确定要删除吗?", function(result) {
                if(result) {
                    top.jzts();
                    var url = "<%=basePath%>live_post/delete.do?TID="+Id+"&tm="+new Date().getTime();
        ...
        function show(ID){
             ...
             diag.Drag=true;
             diag.Title ="查询帖子回复详情";
             diag.URL = '<%=basePath%>live_post/show.do?TID='+ID;
             diag.Width = 800;
             diag.Height = 800;
             diag.CancelEvent = function(){ //关闭事件
                 if(diag.innerFrame.contentWindow.document.getElementById('zhongxin').style.display == 'none'){
        ...
        function edit(Id){
             ...
             diag.Drag=true;
             diag.Title ="编辑";
             diag.URL = '<%=basePath%>live_post/goEdit.do?TID='+Id;
             diag.Width = 1000;
             diag.Height = 1000;
             diag.CancelEvent = function(){ //关闭事件
                 if(diag.innerFrame.contentWindow.document.getElementById('zhongxin').style.display == 'none'){
