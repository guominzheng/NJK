...
<form action="wxController/${msg}" name="Form" id="Form" method="post">
    <input type="hidden" name="zixun_id" value="${pd.zixun_id}" id="zixun_id"/>
    <div id="zhongxin">
        <table id="table_report" class="table table-striped table-bordered table-hover">
            <tr>
                <td style="width:70px;text-align: right;padding-top: 13px;">咨询title:</td>
                <td><input type="text" name="zixun_title" id="zixun_title" value="${pd.zixun_title}" maxlength="32"
                           title="直播间名"
                /></td>
            </tr>
            <tr>
                <td style="width:70px;text-align: right;padding-top: 13px;">咨询内容:</td>
				<td>
                         <textarea  style="width:600px;height: 300px"  name="zixun_context" >${pd.zixun_context}</textarea>
                    </td>
