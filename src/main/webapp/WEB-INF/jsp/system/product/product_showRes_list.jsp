        ...
        <div id="page-content" class="clearfix">
            ...
            <div class="row-fluid">
                ...
                <div class="row-fluid">
                    ...
                    <!-- 检索  -->
                   <form action="product/goLookRes" method="post" name="Form" id="Form">
                                        ...
                                        <c:forEach items="${varList}" var="var" varStatus="vs">
                                            <tr>
                                                <td class='center' style="width: 30px;"><label><input
                                                        type='checkbox' name='ids' value="${var.COMMENT_RESEARCH_ID}" /><span
                                                ...
                                                <td class='center'><a
                                                        ...
                                                        onclick="saveR('${var.COMMENT_RESEARCH_ID}');">回复</a></td>
                                                    ...
                                                    <div class='hidden-phone visible-desktop btn-group'>
                                                        ...
                                                        <div class="inline position-relative">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-icon-only dropdown-light pull-right dropdown-caret dropdown-close">
                                                                <c:if test="${QX.del == 1 }">
                                                                    <li><a style="cursor:pointer;" title="删除" onclick="del('${var.COMMENT_RESEARCH_ID}');" class="tooltip-error" data-rel="tooltip" title="" data-placement="left"><span class="red"><i class="icon-trash"></i></span> </a></li>
                                                                </c:if>
                                                            </ul>
                                                        </div>
                                                    </div>
                            ...
                            <table style="width: 100%;">
                                <tr>
                                    <td style="vertical-align: top;"><c:if
                                            test="${QX.add == 1 }">
                                        <a class="btn btn-small btn-success" onclick="saveUR('${pd.RESEARCH_ID}');">回复</a>
                                    </c:if>
                                         <c:if test="${QX.del == 1 }">
...
<script type="text/javascript">
    ...
    function saveR(id){
        ...
        diag.Drag=true;
        diag.Title ="新增";
        diag.URL = '<%=basePath%>product/goComR.do?COMMENT_RESEARCH_ID='+id;
        diag.Width = 1000;
        diag.Height = 1000;
        diag.CancelEvent = function(){ //关闭事件
            if(diag.innerFrame.contentWindow.document.getElementById('zhongxin').style.display == 'none'){
    ...
    function saveUR(id){
        ...
        diag.Drag=true;
        diag.Title ="添加主评论";
        diag.URL = '<%=basePath%>product/goZComRs.do?RESEARCH_ID='+id;
        diag.Width = 1000;
        diag.Height = 1000;
        diag.CancelEvent = function(){ //关闭事件
            if(diag.innerFrame.contentWindow.document.getElementById('zhongxin').style.display == 'none'){
