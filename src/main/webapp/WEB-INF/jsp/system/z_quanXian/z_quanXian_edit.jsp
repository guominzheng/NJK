...
<body>
	<form action="z_quanXian/${msg }.do" name="Form" id="Form" method="post">
		<input type="hidden" name="USER_ID" id="USER_ID" value="${pd.USER_ID}"/>
		<div id="zhongxin">
		<table id="table_report" class="table table-striped table-bordered table-hover">
			<tr>
				<td style="width:70px;text-align: right;padding-top: 13px;">直播:</td>
				<td style="vertical-align:top;"> 
                       <select class="chzn-select" name="ACTIVITY_ID" id="ACTIVITY_ID"
