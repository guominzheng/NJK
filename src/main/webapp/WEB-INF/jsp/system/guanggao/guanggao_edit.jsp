...
<script type="text/javascript">
	...
	//删除图片
	function delP(IMG,GUANGGAO_ID){
		if(confirm("确定要删除图片？")){
			var url = "guanggao/deltp.do?IMG="+IMG+"&GUANGGAO_ID="+GUANGGAO_ID+"&guid="+new Date().getTime();
...
<body>
	<form action="guanggao/${msg }.do" name="Form" id="Form" method="post">
		...
		<table id="table_report" class="table table-striped table-bordered table-hover">
			...
			<tr>
				...
				<td><input type="text" name="ID" id="ID" value="${pd.ID}" maxlength="32" placeholder="这里输入ID" title="ID"/></td>
			</tr>
			<tr>
				...
				<td>
					...
					<c:if test="${(not empty pd.IMG) && (pd.IMG ne '')}">
						<div id="delP">
							<input type="button"  class="btn btn-mini btn-danger"  value="删除图片" onclick="delP('${pd.IMG}','${pd.GUANGGAO_ID }');" /><br>
