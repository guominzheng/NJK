...
<form action="jifen_shopController/${msg }.do" name="Form" id="Form" method="post">
    ...
    <div id="zhongxin">
        <table id="table_report" class="table table-striped table-bordered table-hover">
            <tr>
                <td style="width:70px;text-align: right;padding-top: 13px;">物流公司:</td>
                <td><input type="text" name="PRISE" id="PRISE" value="${pd.PRISE}" maxlength="32" placeholder="这里输入物流公司" title="物流公司"/></td>
            </tr>
            <tr>
                <td style="width:70px;text-align: right;padding-top: 13px;">物流单号:</td>
                <td><input type="text" name="ORDER" id="ORDER" value="${pd.ORDER}" maxlength="32" placeholder="这里输入物流单号" title="物流单号"/></td>
            </tr>
            <tr>
