...
<%--         <tr>
                ...
                <td><input type="text" name="PROMPT" id="PROMPT" value="${pd.PROMPT}" maxlength="32" placeholder="这里输入提示" title="提示"/></td>
        </tr> --%>
<%--         <tr>
                <td style="width:70px;text-align: right;padding-top: 13px;">排序:</td>
                <td><input type="text" name="ORDE_BY" id="ORDE_BY" value="${pd.ORDE_BY}" maxlength="32" placeholder="这里输入排序" title="排序"/></td>
        </tr> --%>
                    <tr>
