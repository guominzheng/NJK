        ...
        <div id="page-content" class="clearfix">
            ...
            <div class="row-fluid">
                ...
                <div class="row-fluid">
                    ...
                    <!-- 检索  -->
                    <form action="activity_post/Pshow.do" method="post" name="Form" id="Form">
                                ...
                                <c:choose>
                                            ...
                                            <c:forEach items="${varList}" var="var" varStatus="vs">
                                                <tr>
                                                    <td class='center' style="width: 30px;"><label><input
                                                            type='checkbox' name='ids' value="${var.ACTIVITY_POST_ID}" />
                                                            <span
                                                    ...
                                                    <td class='center'><a
                                                        ...
                                                        onclick="show('${var.ACTIVITY_POST_ID}');">评论</a></td>
                                    ...
                                    <div class='hidden-phone visible-desktop btn-group'>
                                        ...
                                        <ul class="dropdown-menu dropdown-icon-only dropdown-light pull-right dropdown-caret dropdown-close">
                                            ...
                                            <li><a style="cursor:pointer;" title="删除" onclick="del('${var.ACTIVITY_POST_ID}');" class="tooltip-error" data-rel="tooltip" title="" data-placement="left"><span class="red"><i class="icon-trash"></i></span> </a></li>
                                        </ul>
                                        </div>
                                    </div>
                                </td>
    ...
    <script type="text/javascript">
        ...
        function del(Id){
            bootbox.confirm("确定要删除吗?", function(result) {
                if(result) {
                    top.jzts();
                    var url = "<%=basePath%>activity_post/delete.do?ACTIVITY_POST_ID="+Id+"&tm="+new Date().getTime();
        ...
        function show(ID){
             ...
             var diag = new top.Dialog();
             diag.Drag=true;
             diag.Title ="查询直播帖子评论列表";
             diag.URL = '<%=basePath%>activity_post/show.do?ACTIVITY_POST_ID='+ID;
             diag.Width = 1000;
             diag.Height = 1000;
             diag.CancelEvent = function(){ //关闭事件
                 if(diag.innerFrame.contentWindow.document.getElementById('zhongxin').style.display == 'none'){
