...
<div id="page-content" class="clearfix">
  ...
  <div class="row-fluid">
    ...
    <div class="row-fluid">
            ...
            <!-- 检索  -->
            <form action="ogin_record/renshu.do" method="post" name="Form" id="Form">
                        ...
                        <c:forEach items="${varList}" var="var" varStatus="vs">
                            <tr>
                                ...
                                <td class='center' style="width: 30px;">${vs.index+1}</td>
                                 <td class="center">
                                    <a href="javascript:show('${var.USER_ID}')">${var.USERNAME}</a>
                                  </td>
                                <td class="center">
                                 <a href="javascript:show('${var.USER_ID}')">${var.NAME}</a>
                                 </td>
    ...
    <!-- PAGE CONTENT ENDS HERE -->
        ...
        function show(id){
             ...
             diag.Drag=true;
             diag.Title ="查询用户查看信息";
             diag.URL = '<%=basePath%>content/show.do?USER_ID='+id;
             diag.Width = 800;
             diag.Height = 800;
