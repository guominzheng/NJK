                                    ...
                                    <c:forEach items="${varList}" var="var" varStatus="vs">
                                        <tr>
                                            <td class='center' style="width: 30px;"><label><input
                                                    type='checkbox' name='ids' value="${var.COUPON_ID}"/><span
                                                    class="lbl"></span></label></td>
                                            <td class='center' style="width: 30px;">${vs.index+1}</td>
                                            <td class='center' width="100px"><span
                                                    class="label label-success arrowed"><a href="javascript:findOrder('${var.USERNAME}')"> ${var.USERNAME}</a></span></td>
                                            ...
                                            <td class='center'><c:if test="${var.STATUS ==0}"><span
                                                    class="label label-important arrowed-in">未使用</span></c:if> <c:if
                                                    test="${var.STATUS ==1}"><span class="label label-success arrowed">已使用</span></c:if>
                                            </td>
                        ...
                        <table style="width: 100%;">
                            <tr>
                                <td style="vertical-align: top;">
                                    <c:if
                                            test="${QX.add == 1 }">
                                        <a class="btn btn-small btn-success" onclick="one();">发送所有会员</a>
                                    </c:if><c:if
                                        test="${QX.add == 1 }">
...
<script type="text/javascript">
    ...
    function one() {
        ...
        diag.Drag = true;
        diag.Title = "优惠券";
        diag.URL = '<%=basePath%>coupon/goOne.do?';
        diag.Width = 450;
        diag.Height = 355;
        diag.CancelEvent = function () { //关闭事件
            if (diag.innerFrame.contentWindow.document.getElementById('zhongxin').style.display == 'none') {
