...
<script type="text/javascript">
  ...
  //删除图片
	...
	function delPP(IMG,TID){
		if(confirm("确定要删除图片？")){
			var url = "post/deltpp.do?FIMG="+IMG+"&TID="+TID+"&guid="+new Date().getTime();
			$.get(url,function(data){
					document.location.reload();
				if(data=="success"){
					$("#uploadName").val("");
...
<body>
    <form action="special/${msg }.do" name="Form" id="Form" method="post">
        ...
        <table id="table_report" class="table table-striped table-bordered table-hover">
            ...
            <tr>
                <td style="width:70px;text-align: right;padding-top: 13px;">提示:</td>
                <td><input style="width:300PX" type="text" name="KEYWORD1" id="KEYWORD1" value="${pd.KEYWORD1}" maxlength="300" placeholder="这里输入提示" title="提示"/></td>
            </tr>
            <tr>
                <td style="width:70px;text-align: right;padding-top: 13px;">排序:</td>
                <td><input style="width:300PX" type="text" name="ORDE_BY" id="ORDE_BY" value="${pd.ORDE_BY}" maxlength="300" placeholder="这里输入排序" title="paixu1"/></td>
            </tr>
            <tr>
