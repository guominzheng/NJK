...
<script type="text/javascript">
	...
	//删除图片
	function delP(IMG,INTEGRAL_INFO_ID){
		if(confirm("确定要删除图片？")){
			var url = "integral/deltp1.do?IMG="+IMG+"&INTEGRAL_INFO_ID="+INTEGRAL_INFO_ID+"&guid="+new Date().getTime();
...
<body>
	...
	<input type="hidden" name="INTEGRAL_INFO_ID" id="INTEGRAL_INFO_ID" value="${pd.INTEGRAL_INFO_ID}"/>
		<div id="zhongxin">
		<table id="table_report" class="table table-striped table-bordered table-hover">
			...
			<tr>
				...
				<td><input type="text" name="MONEY" id="MONEY" value="${pd.MONEY}" maxlength="32" placeholder="这里输入价格" title="价格"/></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>
					...
					<c:if test="${(not empty pd.IMG) && (pd.IMG ne '')}">
						<div id="delP">
							<input type="button"  class="btn btn-mini btn-danger"  value="删除图片" onclick="delP('${pd.IMG}','${pd.INTEGRAL_INFO_ID}');" /><br>
